...
namespace _08_Interfaces
{
    ...
    {
        string Name { get; }                          //"Get" only, when we want to pull a name from our fruit, it will already have a name (no set)
    ...
    public class Grape : IFruit
    {
        ...
        public class IntroductionToInterfaces
        {
            ...
            [TestMethod]
            public void InterfacesCollections()
            {
